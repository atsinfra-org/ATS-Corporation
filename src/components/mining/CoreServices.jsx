...
export default function CoreServices({ onContactClick }) {
  ...
  return (
    <section id="services" className="bg-surface py-24 md:py-32">
      ...
      <Modal open={!!active} onClose={close} labelledBy="mining-service-modal-title" className="max-w-lg p-6 sm:p-9">
        {active && (
          <>
            <button
              type="button"
            ...
            <h3 id="mining-service-modal-title" className="mt-6 font-heading text-2xl font-bold text-ink">
              {active.name}
            </h3>
