...
export default function ServiceOverview({ onContactClick }) {
  ...
  return (
    <section id="services" className="bg-surface py-24 md:py-32">
          ...
          {engineeringServices.map((service, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`relative w-full overflow-hidden ${featured ? "aspect-[8/5]" : "aspect-[4/5]"
                      }`}
                  >
                    <img
                      src={service.image}
                  ...
                  <div className={`flex flex-1 flex-col ${featured ? "p-7 md:p-8" : "p-6"}`}>
                    ...
                    <h3
                      className={`mt-3 font-heading font-bold leading-tight text-ink ${featured ? "text-2xl md:text-3xl uppercase" : "text-lg md:text-xl"
                        }`}
                    >
                      {service.name}
                    </h3>
                    <p
                      className={`mt-3 leading-relaxed text-muted ${featured ? "max-w-md text-base" : "text-sm"
                        }`}
                    >
                      {service.description}
                    </p>
      ...
      <Modal open={!!active} onClose={close} labelledBy="eng-service-modal-title" className="max-w-lg p-0">
        {active && (
          <>
