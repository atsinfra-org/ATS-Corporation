...
import { Clock, ListChecks, Wrench, ShieldCheck } from "lucide-react";
    ...
    <section id="process" className="bg-surface py-24 md:py-32">
      <Container>
        <SectionHeading
          ...
          description="Six controlled phases keep every deployment compliant, safe, and on schedule."
        />
        ...
        <div className="mx-auto mt-16 grid max-w-3xl grid-cols-[40px_1fr] gap-5 sm:grid-cols-[56px_1fr] sm:gap-6">
          ...
          <div>
            {deploymentProcess.map((step, i) => {
              const isLast = i === deploymentProcess.length - 1;
              return (
                  ...
                  >
                    ...
                    <div className="mt-6">
                      <DetailGroup
                        ...
                        items={step.complianceChecklist}
                        inline
                      />
                    </div>
                  </div>
