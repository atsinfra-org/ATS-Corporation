...
const HERO_IMAGE =
  "https://images.unsplash.com/photo-1711012604128-8339024a3e12?q=80&w=2400&auto=format&fit=crop";

export default function MiningHero({ onOpenRegistration }) {
        ...
        <div className="mx-auto w-full max-w-7xl px-6 md:px-10 lg:px-16">
          ...
          >
            <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-gold">
              ...
              ATS Corps Mining Manpower Division
            </span>
            <h1 className="mt-5 font-heading text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.08] text-white text-balance">
              Mining Manpower Solutions
            </h1>
            <p className="mt-5 max-w-2xl text-base md:text-lg leading-relaxed text-white/75">
              Providing skilled manpower for mining, mineral exploration, geological
              surveys, and industrial operations with a commitment to safety, efficiency,
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              ...
              <Button as="button" onClick={() => onOpenRegistration("contact")} variant="outline">
                Contact Our Team
              </Button>
            </div>
          </motion.div>
